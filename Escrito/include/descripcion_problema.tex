...
\cmf{Y el contenido de ésta sección?}

\section{Tienda asociada}

\red{Hablaré con el profesor sobre el uso de la tienda}
...
monetario.\cmf{Que usaste que se pagaba? si fue sólo Wordpress con plugins
puedes decir que es OpenSource, y que tiene costo cero}
