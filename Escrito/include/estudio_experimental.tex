...
ventas de vídeo juegos la cual fue descrita en el capitulo \ref{ch:desc}.

Antes de iniciar la implementación de {\GAM}, se tuvieron que establecer los beneficios dados a los 
...
$1$ peso. También existía una restricción a la hora de utilizar los puntos como descuentos, este 
era que no se podían utilizar para disminuir mas de un 7\%.
...
tienda virtual deja de ser efectiva en la parte transacción al vender.
...
de {\GAM} sea erróneo, sino que el ambiente en el cual fue implementado no ayudo
al éxito de este. Factores como la falta la falta de difusión de la tienda online,
...
para generar un sentimiento de seguridad para que confíen en esta y en el sistema de pagos, 
