...
\end{tabular}
\caption{Tabla de comparacion entre los sistemas bases investigados}
...
si les interesa la idea de utilizar gamification en ventas \emph{on-line}. Esta informacion
