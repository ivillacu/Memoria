...
Uno de los temas importantes a la hora de implementar la solución es la traducción al idioma principal, español, 
 de las herramientas. Algunas tienen soporte oficial de idioma español y para las demas fue necesario realizar una
 traducción dura, directamente en el codigo fuente. Las primeras herramientas mencionadas son:

\begin{itemize}

\item Wordpress: Soporte oficial de idioma español.
\item 
