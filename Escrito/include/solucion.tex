\red{Hoy sacare las imagenes con mejor resolucion y a pantalla completa}
...
\cmf{Puedes leer algo de la imagen? la agrandé pero aún así cuesta.
Si tienes problemas, puedes cambiar tu resolución a 800x600 y sacar un nuevo
screenshot}
...
\cmf{ Por qué el screenshot del "tema" y este dicen "Mystile" arriba?
no le cambiaste el título al tema?? Nuevamente no puedo leer lo que dice
el monito de bienvenido....}
...
\cmf{tampoco se ve muy bien, pero un poco mejor...por qué dice Mystile de nuevo?
que es lo que se vé abajo a la izquierda}
