...
En el siguiente cuadro se hace la comparacion de los tres sistemas preseleccionados para implementar
la solucion propuesta.

\begin{table}[h]
\begin{tabular}{lccccc}
                        & \begin{tabular}[c]{@{}c@{}}Dificultad\\ Instalacion\end{tabular} & \begin{tabular}[c]{@{}c@{}}Dificultad\\ Administracion\end{tabular} & \begin{tabular}[c]{@{}c@{}}Actualizaciones y\\ Comunidad\end{tabular} & \begin{tabular}[c]{@{}c@{}}Caracteristicas\\ Utilizables\end{tabular}             & Traduccion \\
Magento                 & 7                                                                & 8                                                                   & 3                                                                     & \begin{tabular}[c]{@{}c@{}}Si, \\ Alto costo\end{tabular}                         & Casi       \\
Prestashop              & 6                                                                & 7                                                                   & 4                                                                     & No                                                                                & Si         \\
Wordpress + Woocommerce & 4                                                                & 5                                                                   & 7                                                                     & \begin{tabular}[c]{@{}c@{}}Si,\\ Gratuitas\\ Bajo costo\\ Alto Costo\end{tabular} & Si        
\end{tabular}
\end{table}
