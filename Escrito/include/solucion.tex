...
Uno de los temas importantes a la hora de implementar la solución es la traducción al idioma principal, español, 
 de las herramientas. Algunas de estas poseen soporte oficial de idioma español y en las demas fue necesario 
realizar una traducción directamente en el codigo fuente. Las herramientas con soporte oficial son:
...
\item WPAchievement.
\item Refer a Friend.
\item Tema visual MyStile.

\end{itemize}

La internacionalizacion de las harrmientas con soporte es una tarea compleja y que consume una cantidad
de tiempo grande. Esta dificultad se vio reflejada en que las harramientas fueron traducidas en una gran
parte pero no en su totalidad debido a que existe una parte de la información que se presenta con imagenes
