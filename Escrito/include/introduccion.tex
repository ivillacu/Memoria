...
\begin{itemize}
    \item {\bf Magento}~\footnote{http://www.magento.com}:
        Plataforma stand-alone OpenSource que es utilizada para crear tiendas on-line
...
En el presente trabajo, combinaremos un sistema de ventas on-line, concentrándonos
...
\begin{itemize}
    \item Evaluar el impacto de {\GAM} en ventas de videojuegos on-line.
\end{itemize}
